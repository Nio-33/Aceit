    ...
    try {
      ...
      if (!isInitialized && mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text("Firebase Authentication may not be properly configured. Some features may not work."),
    ...
    try {
      ...
      Future.delayed(const Duration(seconds: 10), () {
        if (_isLoading && mounted) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text("Login attempt timed out. Firebase may not be properly configured."),
              duration: Duration(seconds: 5),
            ),
          );
        }
      ...
      if (mounted) {
        ...
        if (e.toString().contains('user-not-found')) {
          ...
          errorMessage = "Firebase Authentication is not properly configured. Please check Firebase setup.";
        } else {
