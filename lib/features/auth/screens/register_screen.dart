  ...
  Future<void> _handleRegister() async {
    ...
    Future.delayed(const Duration(seconds: 15), () {
      if (_isLoading && mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text(
                "Registration timed out. Firebase may not be properly configured."),
    ...
    try {
      ...
      if (!timeoutOccurred) {
        ...
        debugPrint(
            'RegisterScreen: Registering with email: ${_emailController.text.trim()}');
        ...
        await authProvider.register(
          ...
          department:
              'Science', // Temporary default, will be updated after verification
          selectedSubjects: [
            'Mathematics',
            'English'
          ], // Temporary defaults, will be updated after verification
        );

        debugPrint(
            'RegisterScreen: Registration successful, navigating to verification screen');
      ...
      if (mounted) {
        ...
        if (e.toString().contains('email-already-in-use')) {
          ...
          errorMessage =
              "Firebase Authentication is not properly configured. Please try again later.";
        } else {
