  ...
  static Future<void> ensureAssetsExist() async {
    ...
    try {
      ...
      if (!logoFile.existsSync()) {
        ...
        final ByteData data = await rootBundle.load('packages/flutter/lib/assets/flutter_assets/flutter_logo.png');
      ...
      _createPlaceholderTextFile('assets/images/placeholder.txt', 'This directory contains image assets for the AceIt app.');
      _createPlaceholderTextFile('assets/icons/placeholder.txt', 'This directory contains icon assets for the AceIt app.');
